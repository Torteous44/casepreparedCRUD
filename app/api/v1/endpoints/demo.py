...
DEMO_TEMPLATES = {
    "market-entry": {
        ...
        "title": "Beautify Virtual Channels Strategy",
        "description_short": "Evaluate whether a global beauty products company should train in-store beauty consultants in the effective use of virtual channels to connect with customers.",
        "description_long": "Beautify is a global beauty products company considering training their in-store beauty consultants to effectively use virtual channels to connect with customers. Your task is to evaluate if this is a good strategic move and how it should be implemented.",
...
• Transportation costs for parts/technicians
    ...
    "profitability": {
        ...
        "difficulty": "Hard",
        "company": "Coffee Shop Co.",
        "industry": "Food & Beverage",
        "title": "Coffee Shop Co. Growth Strategy",
        "description_short": "A specialty coffee company wants to accelerate growth. Identify key market opportunities, evaluate profitability levers, and recommend a strategy to expand their footprint.",
        "description_long": "Coffee Shop Co. is a specialty coffee company looking to accelerate their growth. They've hired your team to identify key market opportunities, evaluate profitability levers, and recommend a comprehensive strategy to expand their market footprint while maintaining brand quality.",
...
• Risks: Locked-in contracts, bugs, implementation disruptions, security concerns
    ...
    "merger": {
        ...
        "company": "GlobalCorp",
        "industry": "Consumer Goods",
        "title": "GlobalCorp Climate Impact Initiative",
        "description_short": "The CEO of a global company wants to reduce their environmental impact. Build the business case for setting a climate target and determine what initiatives to undertake to achieve it.",
        "description_long": "The CEO of GlobalCorp, a major consumer goods company with a wide variety of personal care products, wants to reduce their environmental impact and do their part in the fight against climate change. Your team has been engaged to help create a business case for setting science-based targets and determining what initiatives to undertake to achieve these targets.",
